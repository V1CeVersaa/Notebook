...
<img class="center-picture" src="./assets/12-1.webp" width=600 />
...
<img class="center-picture" src="./assets/13-1.webp" width=600 />
...
<img class="center-picture" src="./assets/13-2.webp" width=600 />
...
<img class="center-picture" src="./assets/13-3.webp" width=600 />
...
<img class="center-picture" src="./assets/13-4.webp" width=600 />
...
<img class="center-picture" src="./assets/13-5.webp" width=600 />
...
<img class="center-picture" src="./assets/13-6.webp" width=600 />
...
<img class="center-picture" src="./assets/14-0.webp" width=600 />
...
<img class="center-picture" src="./assets/14-1.webp" width=600 />
...
<img class="center-picture" src="./assets/14-2.webp" alt="RoI Pool" width=600 />

<img class="center-picture" src="./assets/14-3.webp" alt="RoI Align" width=600 />

<img class="center-picture" src="./assets/14-4.webp" alt="RoI Align" width=600 />
...
<img class="center-picture" src="./assets/14-5.webp" width=600 />
...
<img class="center-picture" src="./assets/14-6.webp" width=600 />
...
<img class="center-picture" src="./assets/14-7.webp" width=600 />
...
<img class="center-picture" src="./assets/14-8.webp" width=600 />
...
<img class="center-picture" src="./assets/14-9.webp" width=600 />
...
<img class="center-picture" src="./assets/14-10.webp" width=600 />
...
<img class="center-picture" src="./assets/14-11.webp" width=600 />
...
<img class="center-picture" src="./assets/14-12.webp" width=600 />

<img class="center-picture" src="./assets/14-13.webp" width=600 />
...
<img class="center-picture" src="./assets_1/15-1.webp" width=600 />
...
<img class="center-picture" src="./assets_1/15-2.webp" width=600 />

反池化/Unpooling：将每一个小块池化后的值赋给这个小块内的每一个值：

<img class="center-picture" src="./assets_1/15-3.webp" width=600 />

也有一种方法是在最大池化的时候记住最大值的位置，再在上采样的时候将最大值的位置填回去：

<img class="center-picture" src="./assets_1/15-4.webp" width=600 />

同理还有双线性插值/Bilinear Interpolation 以及双三次插值/Bicubic Interpolation：

<img class="center-picture" src="./assets_1/15-5.webp" width=600 />

<img class="center-picture" src="./assets_1/15-6.webp" width=600 />

Transposed Convolution/反卷积/转置卷积是一种可学习的上采样方法，其本质是卷积层的转置：

<img class="center-picture" src="./assets_1/15-7.webp" width=600 />

<img class="center-picture" src="./assets_1/15-8.webp" width=600 />

<img class="center-picture" src="./assets_1/15-9.webp" width=600 />
...
<img class="center-picture" src="./assets_1/15-10.webp" width=600 />
...
<img class="center-picture" src="./assets_1/15-11.webp" width=600 />

另一个任务是 Human Keypoint Detection/人体关键点检测，也称为 Pose Estimation/姿态估计，目标是通过定位一组关键点来描述人体姿态。

<img class="center-picture" src="./assets_1/15-12.webp" width=600 />
...
<img class="center-picture" src="./assets_1/15-13.webp" width=600 />

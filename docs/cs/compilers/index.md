...
!!! Abstract "「大二春夏」"
    ...
    上得很爽！但是备考很刺激。**有一些确定不考的以及比较基本的内容就再也不补了**。
    
    准备明年修姚老师的《编程语言原理》了。

## Table of Contents

- [ ] [Topic 1：词法分析](./1_lex.md)
- [x] [Topic 2：语法分析](./2_parse.md)
- [ ] [Topic 3：抽象语法](./3_ast.md)
- [x] [Topic 4：语义分析](./4_semantic.md)
- [x] [Topic 5：活动记录](./5_activation.md)
- [x] [Topic 6：中间表示生成](./6_IR.md)
- [x] [Topic 7：基本块与 Traces](./7_block.md)
- [x] [Topic 8：指令选择](./8_instruction.md)
- [x] [Topic 9：活跃变量分析](./9_liveness.md)
- [x] [Topic 10：寄存器分配](./10_register.md)
- [x] [Topic 11：垃圾回收](./11_garbage.md)
- [x] [Topic 12：面向对象语言](./12_oop.md) （在虎书上是 Chapter 13）
- [x] [Topic 13：循环优化](./13_loop.md) （在虎书上是 Chapter 14）

## Introduction

<img class="center-picture" src="./assets/0 index/0-1.webp" width=550 />

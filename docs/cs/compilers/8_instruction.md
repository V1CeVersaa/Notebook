...
<img class="center-picture" src="./assets/8 instruction/8-1.webp" width=600 />

<img class="center-picture" src="./assets/8 instruction/8-2.webp" width=600 />

下面就是指令选择的一个例子：

<img class="center-picture" src="./assets/8 instruction/8-3.webp" width=600 />
...
<img class="center-picture" src="./assets/8 instruction/8-4.webp" width=550 />
...
<img class="center-picture" src="./assets/8 instruction/8-5.webp" width=550 />
...
<img class="center-picture" src="./assets/8 instruction/8-6.webp" width=550 />

<img class="center-picture" src="./assets/8 instruction/8-7.webp" width=550 />
...
<img class="center-picture" src="./assets/8 instruction/8-8.webp" width=550 />

两个算法的效率如下，这意味着两个算法其实都是线性复杂度的：

<img class="center-picture" src="./assets/8 instruction/8-9.webp" width=550 />
...
<img class="center-picture" src="./assets/8 instruction/8-10.webp" width=550 />
...
<img class="center-picture" src="./assets/8 instruction/8-11.webp" width=600 />
...
<img class="center-picture" src="./assets/8 instruction/8-12.webp" width=600 />

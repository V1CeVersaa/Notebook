...
- [ ] [Principles of Compilers: Lexical Analysis](./compilers/1_lex.md)
- [ ] [Principles of Compilers: Syntax Analysis](./compilers/2_parse.md)
- [ ] [Principles of Compilers: Abstract Syntax](./compilers/3_ast.md)
- [x] [Principles of Compilers: Semantic Analysis](./compilers/4_semantic.md)
- [x] [Principles of Compilers: Activation Records](./compilers/5_activation.md)
- [x] [Principles of Compilers: Translating into IR](./compilers/6_IR.md)
- [x] [Principles of Compilers: Basic Blocks and Traces](./compilers/7_block.md)
- [x] [Principles of Compilers: Instruction Selection](./compilers/8_instruction.md)
- [x] [Principles of Compilers: Liveness Analysis](./compilers/9_liveness.md)
- [x] [Principles of Compilers: Register Allocation](./compilers/10_register.md)
- [x] [Principles of Compilers: Garbage Collection](./compilers/11_garbage.md)
- [x] [Principles of Compilers: Object-Oriented Languages](./compilers/12_oop.md)
- [x] [Principles of Compilers: Loop Optimizations](./compilers/13_loop.md)

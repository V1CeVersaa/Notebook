...
<img class="center-picture" src="./assets/alpha-purning.webp" alt="drawing" width="400" />

<!-- ![alt text](./Lec3-imgs/5-alpha-purning.webp) -->
...
<img class="center-picture" src="./assets/matrix-mul.webp" alt="drawing" width="500" />
...
!!! Example "讲义上的例子"
    ...
    <img class="center-picture" src="./assets/Greedy-1.webp" alt="drawing" width="500" />

...
## Lecture 10: Optimal Control and Plannning
...
- 随机情形下的开环规划无法利用未来揭示的信息，往往次优；更合理的是闭环规划，即直接优化策略 $\pi(a_t\mid s_t)$。
...
$$
\mathrm{score}(i)
= \underbrace{\frac{Q_i}{N_i}}_{\text{当前平均价值}}
+ c\,\sqrt{\frac{2\ln N_{\text{parent}}}{N_i}},
$$
...
c_t(x_t,u_t)
&\approx \hat{c}_t
+ c_{x,t}^\top\delta x_t + c_{u,t}^\top\delta u_t \\
&\quad + \tfrac12
